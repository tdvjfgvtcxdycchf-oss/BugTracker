      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input type="text" required className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Введите название задачи..." value={name} onChange={(e) => setName(e.target.value)} />
          </div>
          <div>
            <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Описание</label>
            <textarea required rows={3} className="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Опишите требования..." value={desc} onChange={(e) => setDesc(e.target.value)} />
          </div>
